!(function (e) {
  ...
  function f(e, o, n) {
    ...
    return (
      ...
      "string" == typeof o ? (e.innerHTML = o) : e.appendChild(o),
      s.addClass(t, "dialog-opened"),
      e
    );
  }
  function p(e, o) {
  ...
  (s.defineExtension("openDialog", function (e, o, n) {
    ...
    return (
      l
        ? (l.focus(),
          n.value &&
            ((l.value = n.value), !1 !== n.selectValueOnOpen && l.select()),
          n.onInput &&
            s.on(l, "input", function (e) {
              n.onInput(e, l.value, u);
            }),
          n.onKeyUp &&
            s.on(l, "keyup", function (e) {
              n.onKeyUp(e, l.value, u);
            }),
          s.on(l, "keydown", function (e) {
            (n && n.onKeyDown && n.onKeyDown(e, l.value, u)) ||
              ((27 == e.keyCode ||
          ...
          !1 !== n.closeOnBlur &&
            s.on(t, "focusout", function (e) {
              null !== e.relatedTarget && u();
            }))
        : (e = t.getElementsByTagName("button")[0]) &&
          (s.on(e, "click", function () {
            (u(), r.focus());
          }),
    ...
    s.defineExtension("openNotification", function (e, o) {
      ...
      var n,
        ...
        i = !1,
        o = o && void 0 !== o.duration ? o.duration : 5e3;
      function r() {
        i ||
          ((i = !0),
          clearTimeout(n),
