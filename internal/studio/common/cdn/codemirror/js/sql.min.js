!(function (e) {
  ...
  a.defineMode("sql", function (r, e) {
    var n = e.client || {},
      i = e.atoms || { false: !0, true: !0, null: !0 },
      o = e.builtin || y(v),
      s = e.keywords || y(f),
      l = e.operatorChars || /^[*+\-%<>!=&|~^\/]/,
      c = e.support || {},
      d = e.hooks || {},
      u = e.dateSQL || { date: !0, time: !0, timestamp: !0 },
    ...
    function h(e, t) {
      ...
      if (
        !(
          (c.nCharCast && ("n" == r || "N" == r)) ||
          (c.charsetCast && "_" == r && e.match(/[a-z][a-z0-9]*/i))
        ) ||
        ("'" != e.peek() && '"' != e.peek())
      ) {
        if (
        ...
        if (
          (c.commentHash && "#" == r) ||
          ("-" == r && e.eat("-") && (!c.commentSpaceRequired || e.eat(" ")))
        )
          return (e.skipToEnd(), "comment");
        if ("/" == r && e.eat("*"))
          return (
            (t.tokenize = (function a(n) {
              return function (e, t) {
                var r = e.match(/^.*?(\/\*|\*\/)/);
                return (
                  r
        ...
        if ("." == r)
          return c.zerolessFloat && e.match(/^(?:\d+(?:e[+-]?\d+)?)/i)
            ? "number"
            : e.match(/^\.+/)
              ? null
              : c.ODBCdotTable && e.match(/^[\w\d_$#]+/)
                ? "variable-2"
                : void 0;
        if (l.test(r)) return (e.eatWhile(l), "operator");
        if (p.test(r)) return "bracket";
        if (_.test(r)) return (e.eatWhile(_), "punctuation");
        if (
          "{" == r &&
    ...
    return {
      startState: function () {
        return { tokenize: h, context: null };
      },
      token: function (e, t) {
        if (
          (e.sol() &&
