!(function (e, t) {
  ...
  var se,
    ...
    de =
      ...
      function (e, t) {
        var n = "ltr" == t ? "L" : "R";
        if (0 == e.length || ("ltr" == t && !se.test(e))) return !1;
          ...
          if (ce.test(o[D])) {
            ...
            for (var E = H; E < D; )
              if (he.test(o[E])) {
                ...
                (A.splice(F, 0, new fe(2, I, E)), (F += P), (H = E));
              } else ++E;
        ...
        return (
          "ltr" == t &&
            (1 == A[0].level &&
              (O = e.match(/^\s+/)) &&
              ((A[0].from = O[0].length), A.unshift(new fe(0, 0, O[0].length))),
            1 == Y(A).level &&
              (O = e.match(/\s+$/)) &&
              ((Y(A).to -= O[0].length),
    ...
    me = function (e, t, n) {
      e.addEventListener
        ...
        : e.attachEvent
          ...
          : ((e = e._handlers || (e._handlers = {}))[t] = (e[t] || ge).concat(
              n,
            ));
    };
  function ve(e, t) {
  ...
  function at(e, t) {
    ...
    return t.line > n
      ? tt(n, Ye(e, n).text.length)
      : ((e = Ye(e, (n = t).line).text.length),
        null == (t = n.ch) || e < t
          ? tt(n.line, e)
          : t < 0
            ? tt(n.line, 0)
  ...
  function pt(n, r, e) {
    var t = n.doc,
      i = n.display;
    if (!t.mode.startState) return new ht(t, !0, r);
    var o = (function (e, t, n) {
        for (
          ...
          if (
            u &&
            (!n || s + (u instanceof ct ? u.lookAhead : 0) <= o.modeFrontier)
          )
            return s;
  ...
  ((ht.prototype.lookAhead = function (e) {
    ...
    (ht.fromSaved = function (e, t, n) {
      return t instanceof ct
        ? new ht(e, Ve(e.mode, t.state), n, t.lookAhead)
        : new ht(e, Ve(e.mode, t), n);
    }),
      ...
      var d,
        f =
          c.pos > e.options.maxHighlightLength
            ? ((s = !1), l && gt(e, t, r, c.pos), (c.pos = t.length), null)
            : wt(vt(n, c, r.state, h), o);
      if (
  ...
  function Tt(e, t) {
    ...
    if (s)
      for (var f = 0; f < s.length; ++f) {
        ...
        (null != p.to && (p.to += u),
          null == p.from
            ? kt(l, p.marker) || ((p.from = u), a && (l = l || []).push(p))
    ...
    if (!a) {
      ...
      if (0 < v && l)
        for (var y = 0; y < l.length; ++y)
          null == l[y].to &&
            (m = m || []).push(new Lt(l[y].marker, null, null));
      ...
      ((r.pos = 0),
              ...
              if (v == p) {
                ...
                if (b)
                  for (var L = 0; L < b.length; L += 2)
                    b[L + 1] == v && (u += " " + b[L]);
                if (!h || h.from == p)
                  for (var k = 0; k < y.length; ++k) Zt(t, 0, y[k]);
                if (h && (h.from || 0) == p) {
                  if (
                    (Zt(
                      t,
        ...
        o.styleClasses &&
          (o.styleClasses.bgClass &&
            (r.bgClass = D(o.styleClasses.bgClass, r.bgClass || "")),
          o.styleClasses.textClass &&
            (r.textClass = D(o.styleClasses.textClass, r.textClass || ""))),
        0 == r.map.length &&
          r.map.push(
            0,
            0,
        ...
        for (var c = document.createDocumentFragment(), h = 0; ; ) {
          ...
          ("\t" == d[0]
            ? ((f = (f = e.cm.options.tabSize) - (e.col % f)),
              (p = c.appendChild(M("span", X(f), "cm-tab"))).setAttribute(
                "role",
                "presentation",
              ),
  ...
  function rn(e, t) {
    ...
    if (n.length) {
      ...
      en
        ? (r = en.delayedCallbacks)
        : nn
          ? (r = nn)
          : ((r = nn = []), setTimeout(on, 0));
  ...
  function un(e, t) {
    ...
    ((n = e),
      ...
      t.line.wrapClass
        ? (sn(t).className = t.line.wrapClass)
  ...
  function Ln(e, t) {
    ...
    (o && !o.text
      ? (o = null)
      : o && o.changes && (ln(e, o, i, _n(e)), (e.curOp.forceUpdate = !0)),
      o ||
        ((n = e),
        (e = Ze((r = It((r = t))))),
  ...
  var Tn,
    Mn = { left: 0, right: 0, top: 0, bottom: 0 };
  function Nn(e, t, n) {
  ...
  function Fn(e) {
    var t = It(e).widgets,
      n = 0;
    if (t) for (var r = 0; r < t.length; ++r) t[r].above && (n += fn(t[r]));
    return n;
  }
  function Pn(e, t, n, r, i) {
    ...
    t = Gt(t);
    return (
      "local" == r ? (t += gn(e.display)) : (t -= e.display.viewOffset),
      ("page" != r && "window" != r) ||
        ((t +=
  ...
  function Rn(n, e, r, i, o, l) {
    ...
    ((i = i || Ye(n.doc, e.line)), (o = o || Ln(n, i)));
  ...
  function zn(e, t) {
    var n = 0;
    ((t = at(e.doc, t)), e.options.lineWrapping || (n = $n(e.display) * t.ch));
    ((t = Ye(e.doc, t.line)), (e = Gt(t) + gn(e.display)));
  ...
  function Gn(e, t, n) {
    ...
    for (var l = Ye(r, i); ; ) {
      var s = (function (n, e, t, r, i) {
          ...
          c &&
            ((f = (n.options.lineWrapping ? Xn : jn)(n, e, t, o, c, r, i)),
            (u = 1 != f.level),
            (s = u ? f.from : f.to - 1),
            (a = u ? f.to : f.from - 1));
          var h = null,
      ...
      t = ie(
        function (e) {
          ...
          return Kn(
            Rn(
              n,
              tt(i, e ? t.to : t.from, e ? "before" : "after"),
              "line",
              r,
              o,
            ),
    ...
    return (
      0 < t &&
        ...
        Kn(
          (e = Rn(
            n,
            tt(i, e ? u.from : u.to, e ? "after" : "before"),
            "line",
            r,
            o,
          )),
  ...
  function Yn(e) {
    ...
    if (null == Tn) {
      ...
      for (var t = 0; t < 49; ++t)
        (Tn.appendChild(document.createTextNode("x")), Tn.appendChild(M("br")));
  ...
  function Jn(e, t, n, r) {
    var i = e.display;
    if (!n && "true" == Ne(t).getAttribute("cm-not-content")) return null;
    var o,
    ...
    return (
      r &&
        0 < s.xRel &&
        (l = Ye(e.doc, s.line).text).length == s.ch &&
        ((l = E(l, l.length, e.options.tabSize) - l.length),
        (s = tt(
          s.line,
          Math.max(0, Math.round((o - vn(e.display).left) / $n(e.display)) - l),
        ))),
      s
    );
  }
  ...
  function tr(e, t, n, r) {
    ...
    ((r = r || 0) &&
      ...
      t >= l.viewTo
        ? St && Rt(e.doc, t) < l.viewTo && rr(e)
        : n <= l.viewFrom
          ? St && zt(e.doc, n + r) > l.viewFrom
            ? rr(e)
  ...
  function ir(e, t, n, r) {
    var i,
      o = er(e, t),
      l = e.display.view;
    if (!St || n == e.doc.first + e.doc.size) return { index: o, lineN: n };
  ...
  function sr(e, t) {
    ...
    for (var s, a, u, c = 0; c < n.sel.ranges.length; c++)
      (!t && c == n.sel.primIndex) ||
        ...
        l
          ? (u = l(e, s)) && ar(e, u, i)
          : (a || e.options.showCursorWhenSelecting) && ar(e, s.head, i),
        a ||
          (function (i, e, t) {
            var n = i.display,
              o = i.doc,
              ...
              return (
                (function (e, t, n, r) {
                  ...
                  var i,
                    ...
                    p = !C || r == C.length - 1;
                  (c.top - u.top <= 3
                    ? ((i = (k ? h : d) && f ? S : (a ? u : c).left),
                      (r = (k ? d : h) && p ? L : (a ? c : u).right),
                      T(i, u.top, r - i, u.bottom))
                    : ((n = a
                        ? ((o = k && h && f ? S : u.left),
                          (l = k ? L : x(e, n, "before")),
                          (s = k ? S : x(t, n, "after")),
  ...
  function ar(e, t, n) {
    ...
    ((i.style.left = r.left + "px"),
      ...
      /\bcm-fat-cursor\b/.test(e.getWrapperElement().className) &&
        ((t = (t = In(e, t, "div", null, null)).right - t.left),
  ...
  function gr(e) {
    for (
      ...
      if (!a.hidden) {
        ((i += a.line.height),
          w && v < 8
            ? ((c = (s = a.node.offsetTop + a.node.offsetHeight) - n), (n = s))
            : ((c = (d = a.node.getBoundingClientRect()).bottom - d.top),
              !u &&
                a.text.firstChild &&
                (h =
        ...
        if (
          (0.005 < d || d < -0.005) &&
          (i < r && (o -= d), qe(a.line, c), mr(a.line), a.rest)
        )
          for (var f = 0; f < a.rest.length; f++) mr(a.rest[f]);
        h > e.display.sizerWidth &&
          (h = Math.ceil(h / $n(e.display))) > e.display.maxLineLength &&
  ...
  function vr(e, t, n) {
    ...
    return (
      n &&
        ...
        (n = n.ensure.to.line),
        i < o
          ? (r = Qe(t, Gt(Ye(t, (o = i))) + e.wrapper.clientHeight))
          : Math.min(n, t.lastLine()) >= r &&
            ((o = Qe(t, Gt(Ye(t, n)) - e.wrapper.clientHeight)), (r = n))),
  ...
  function Dr(n) {
    (n.display.scrollbars &&
      ...
      n.display.scrollbars.addClass &&
        S(n.display.wrapper, n.display.scrollbars.addClass)),
      ...
      n.display.scrollbars.addClass &&
        A(n.display.wrapper, n.display.scrollbars.addClass));
  }
  var Wr = 0;
  function Hr(e) {
    ((e.curOp = {
      ...
      en
        ? en.ops.push(e)
        : (e.ownsGroup = en = { ops: [e], delayedCallbacks: [] }));
  }
  function Fr(e) {
    e = e.curOp;
    e &&
            ...
            !(function (e) {
              ...
              ((e.barMeasure = Mr(t)),
                n.maxLineChanged &&
                  ...
                  ((e.adjustWidthTo =
                    Cn(t, n.maxLine, n.maxLine.text.length).left + 3),
                  ...
                  (e.maxScrollLeft = Math.max(
                    0,
                    n.sizer.offsetLeft + e.adjustWidthTo - bn(t),
                  ))));
              ...
              null != e.scrollLeft && Tr(t, e.scrollLeft, !0, !0);
              {
                ...
                e.scrollToPos &&
                  ((i = (function (e, t, n, r) {
                    ...
                    t,
                    at(r, e.scrollToPos.from),
                    at(r, e.scrollToPos.to),
                    e.scrollToPos.margin,
                  )),
                  (function (e, t) {
                    var n, r, i;
                    we(e, "scrollCursorIntoView") ||
                      ...
                      null == i ||
                        ...
                        ((t = M(
                          ...
                          "position: absolute;\n                         top: " +
                            ...
                            "px;\n                         height: " +
                            (t.bottom - t.top + yn(e) + n.barHeight) +
                            "px;\n                         left: " +
                            t.left +
                            "px; width: " +
  ...
  function Ur(e, t) {
    ...
    ((r = o),
      ...
      0 == (l = (o = e).display).view.length || r >= l.viewTo || i <= l.viewFrom
        ? ((l.view = Jt(o, r, i)), (l.viewFrom = r))
        : (l.viewFrom > r
            ? (l.view = Jt(o, r, l.viewFrom).concat(l.view))
            : l.viewFrom < r && (l.view = l.view.slice(er(o, r))),
          (l.viewFrom = r),
          l.viewTo < i
            ? (l.view = l.view.concat(Jt(o, l.viewTo, i)))
      ...
      return (
        !window.getSelection ||
          ((t = window.getSelection()).anchorNode &&
            t.extend &&
            N(e.display.lineDiv, t.anchorNode) &&
    ...
    return (
        ...
        for (var a = r.view, u = r.viewFrom, c = 0; c < a.length; c++) {
          ...
          if (!h.hidden)
            if (h.node && h.node.parentNode == o) {
              ...
              (h.changes &&
                (-1 < R(h.changes, "gutter") && (d = !1), ln(n, h, u, t)),
                d &&
                  (L(h.lineNumber),
                  h.lineNumber.appendChild(
                    document.createTextNode(et(n.options, u)),
                  )),
      ...
      (i = l) &&
        ...
        !/^(INPUT|TEXTAREA)$/.test(i.activeElt.nodeName) &&
          i.anchorNode &&
          N(document.body, i.anchorNode) &&
          N(document.body, i.focusNode) &&
  ...
  function Vr(e, t) {
    for (var n = t.viewport, r = !0; ; r = !1) {
      if (r && e.options.lineWrapping && t.oldDisplayWidth != bn(e))
        ...
        (n &&
          null != n.top &&
          (n = { top: Math.min(e.doc.height + mn(e.display) - wn(e), n.top) }),
  ...
  function jr(e) {
    ...
    ((e.sizer.style.marginLeft = t + "px"), rn(e, "gutterChanged", e));
  }
  function Xr(e, t) {
    ((e.display.sizer.style.minHeight = t.docHeight + "px"),
      (e.display.heightForcer.style.top = t.docHeight + "px"),
      (e.display.gutters.style.height =
        t.docHeight + e.display.barHeight + yn(e) + "px"));
  }
  function Yr(e) {
    var t = e.display,
      n = t.view;
  ...
  function ri(e, t) {
    ...
    if ((r && a) || (i && n)) {
      ...
      if (r && !d && !p && null != o)
        return (
          i && n && Lr(e, Math.max(0, s.scrollTop + i * o)),
      ...
      (i &&
        null != o &&
        ((n = (a = e.doc.scrollTop) + l.wrapper.clientHeight),
        (o = i * o) < 0
          ? (a = Math.max(0, a + o - 50))
          : (n = Math.min(e.doc.height, n + o + 50)),
        Kr(e, { top: a, bottom: n })),
        Jr < 20 &&
          0 !== t.deltaMode &&
          (null == l.wheelStartX
            ? ((l.wheelStartX = s.scrollLeft),
              ...
              setTimeout(function () {
                var e, t;
                null != l.wheelStartX &&
                  ((t = s.scrollLeft - l.wheelStartX),
                  (t =
                    ((e = s.scrollTop - l.wheelStartY) &&
                      l.wheelDY &&
                      e / l.wheelDY) ||
  ...
  ((ii.prototype.primary = function () {
    ...
    (ii.prototype.contains = function (e, t) {
      ...
      for (var n = 0; n < this.ranges.length; n++) {
        var r = this.ranges[n];
        if (0 <= nt(t, r.from()) && nt(e, r.to()) <= 0) return n;
      }
      return -1;
    }));
  var oi = function (e, t) {
  ...
  function hi(e, t, n) {
    return e.line == t.line
      ? tt(n.line, e.ch - t.ch + n.ch)
      : tt(n.line + (e.line - t.line), e.ch);
  }
  function di(e) {
    ((e.doc.mode = Be(e.options, e.doc.modeOption)), fi(e));
  }
  function fi(e) {
  ...
  function gi(e, o, t, l) {
    ...
    function r(e, t) {
      for (var n = [], r = e; r < t; ++r) n.push(new Kt(c[r], i(r), l));
      return n;
    }
    var s,
      a = o.from,
        ...
        : h == d
          ? 1 == c.length
            ...
            : ((s = r(1, c.length - 1)).push(
                new Kt(f + h.text.slice(u.ch), p, l),
              ),
  ...
  function wi(e, t) {
    var n = { from: it(t.from), to: ai(t), text: $e(e, t.from, t.to) };
    return (
  ...
  function Ci(e, t, n, r) {
    ...
    if (
      ...
      ((l = Y(o.changes)),
        0 == nt(t.from, t.to) && 0 == nt(t.from, l.to)
          ? (l.to = ai(t))
  ...
  function Ei(e, t, n) {
    var r, i;
    (Ce(e, "beforeSelectionChange") ||
      (e.cm && Ce(e.cm, "beforeSelectionChange"))) &&
      ((r = e),
      (i = n),
      (i = {
        ranges: (o = t).ranges,
        ...
        if (
          ...
          if (a.atomic) {
            if (n) {
              ...
              if (
                (h = (r < 0 ? c : u)
                  ? Ui(e, h, -r, h && h.line == t.line ? o : null)
                  : h) &&
                h.line == t.line &&
                (s = nt(h, n)) &&
                (r < 0 ? s < 0 : 0 < s)
  ...
  function Ui(e, t, n, r) {
    return n < 0 && 0 == t.ch
      ? t.line > e.first
        ? at(e, tt(t.line - 1))
        : null
      : 0 < n && t.ch == (r || Ye(e, t.line)).text.length
  ...
  function ji(e, t, n) {
    ...
    if (
      !(Ce(e, "beforeChange") || (e.cm && Ce(e.cm, "beforeChange"))) ||
      (t = Ki(e, t, !0))
    ) {
      var r =
        Ct &&
  ...
  function Xi(e, n) {
    var t, r;
    (1 == n.text.length && "" == n.text[0] && 0 == nt(n.from, n.to)) ||
      ((t = ci(e, n)),
  ...
  function Yi(i, o, e) {
    ...
    if (!t || e) {
      ...
      if (u != s.length) {
        ...
        for (
          var h = Ce(i, "beforeChange") || (i.cm && Ce(i.cm, "beforeChange")),
  ...
  function _i(e, t, n, r) {
    if (e.cm && !e.cm.curOp) return Er(e.cm, _i)(e, t, n, r);
    var i;
    t.to.line < e.first
      ? $i(e, t.text.length - 1 - (t.to.line - t.from.line))
      : t.from.line > e.lastLine() ||
        (t.from.line < e.first &&
          ($i(e, (i = t.text.length - 1 - (e.first - t.from.line))),
          (t = {
            from: tt(e.first, 0),
  ...
  function eo(e, t, n, r) {
    var i = t,
      o = t;
    return (
      "number" == typeof t ? (o = Ye(e, st(e, t))) : (i = Ze(t)),
  ...
  function so(r, i, o, e, t) {
    ...
    if (r.cm && !r.cm.curOp) return Er(r.cm, so)(r, i, o, e, t);
    var l = new oo(r, t),
      t = nt(i, o);
    ...
    if (
      ...
      if (
        Et(r, i.line, i, o, l) ||
        (i.line != o.line && Et(r, o.line, i, o, l))
      )
        throw new Error(
    ...
    l.addToHistory && Ci(r, { from: i, to: o, origin: "markText" }, r.sel, NaN);
    var s,
      a = i.line,
      u = r.cm;
    if (
      (r.iter(a, o.line + 1, function (e) {
        var t, n;
        (u &&
          l.collapsed &&
          !u.options.lineWrapping &&
          It(e) == u.display.maxLine &&
          (s = !0),
          ...
          (e =
            (e = r.cm && r.cm.curOp) &&
            window.WeakSet &&
            (e.markedSpans || (e.markedSpans = new WeakSet()))) &&
          e.has(t.markedSpans)
            ? t.markedSpans.push(n)
            : ((t.markedSpans = t.markedSpans
                ? t.markedSpans.concat([n])
                : [n]),
      ...
      l.clearOnEnter &&
        me(l, "beforeCursorEnter", function () {
          return l.clear();
        }),
      l.readOnly &&
        ((Ct = !0),
        (r.history.done.length || r.history.undone.length) && r.clearHistory()),
      l.collapsed && ((l.id = ++lo), (l.atomic = !0)),
      u)
    ) {
      if ((s && (u.curOp.updateMaxLine = !0), l.collapsed))
        ...
        for (var n = i.line; n <= o.line; n++) nr(u, n, "text");
      (l.atomic && Ri(u.doc), rn(u, "markerAdded", u, l));
    }
    return l;
  }
  ((oo.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      ...
      (n && Hr(t),
        !Ce(this, "clear") ||
          ((e = this.find()) && rn(this, "clear", e.from, e.to)));
      for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
        var l = this.lines[o],
          s = kt(l.markedSpans, this);
        (t && !this.collapsed
          ? nr(t, Ze(l), "text")
          : t && (null != s.to && (i = Ze(l)), null != s.from && (r = Ze(l))),
    ...
    (oo.prototype.find = function (e, t) {
      ...
      for (var i = 0; i < this.lines.length; ++i) {
        ...
        if (null != l.from && ((n = tt(t ? o : Ze(o), l.from)), -1 == e))
          return n;
        if (null != l.to && ((r = tt(t ? o : Ze(o), l.to)), 1 == e)) return r;
      }
  ...
  (ho.prototype = q(no.prototype, {
    ...
    getSelection: function (e) {
      for (var t = this.sel.ranges, n = 0; n < t.length; n++)
        var r = $e(this, t[n].from(), t[n].to()), i = i ? i.concat(r) : r;
            ...
            (function (e, t, n) {
              for (
                ...
                var l = t[o],
                  ...
                  i = a;
                "around" == n
                  ? ((l = nt((l = e.sel.ranges[o]).head, l.anchor) < 0),
      ...
      if ((e instanceof cl && (e = e.doc), this.linked))
        for (var t = 0; t < this.linked.length; ++t)
          if (this.linked[t].doc == e) {
            (this.linked.splice(t, 1), e.unlinkDoc(this), co(uo(this)));
            break;
          }
      var n;
  ...
  for (var Lo = 1; Lo <= 12; Lo++) xo[Lo + 111] = xo[Lo + 63235] = "F" + Lo;
  var ko = {};
  function To(e) {
    var t,
      n,
  ...
  function Do(e, t) {
    ...
    return (
      null != n &&
      !e.altGraphKey &&
      Ao((n = 3 == e.keyCode && e.code ? e.code : n), e, t)
    );
  }
  function Wo(e) {
  ...
  function Io(t, n, s, e) {
    ...
    ((h = function (e, t, n) {
      for (
        var r = function (e, t) {
          return t
            ? new tt(s.line, u(e, 1), "before")
            : new tt(s.line, e, "after");
        };
        0 <= e && e < a.length;
        e += t
      ) {
      ...
      return Ho(n, function (e) {
        if (e.empty()) {
          ...
          return e.head.ch == t && e.head.line < n.lastLine()
            ? { from: e.head, to: tt(e.head.line + 1, 0) }
            : { from: e.head, to: tt(e.head.line, t) };
        }
    ...
    transposeChars: function (l) {
      return Pr(l, function () {
        for (
          ...
          r[o].empty() &&
            ((e = r[o].head),
            (t = Ye(l.doc, e.line).text) &&
              (0 < (e = e.ch == t.length ? new tt(e.line, e.ch - 1) : e).ch
                ? ((e = new tt(e.line, e.ch + 1)),
                  l.replaceRange(
                ...
                : e.line > l.doc.first &&
                  (n = Ye(l.doc, e.line - 1).text) &&
                  ((e = new tt(e.line, 1)),
                  l.replaceRange(
                    t.charAt(0) +
                      l.doc.lineSeparator() +
                      n.charAt(n.length - 1),
                    tt(e.line - 1, n.length - 1),
                    e,
                    "+transpose",
                  ))),
            i.push(new oi(e, e)));
  ...
  function Ko(e, t, n, r) {
    r = (function (e, t, n) {
      ...
      return (
        (e.options.extraKeys && No(t, e.options.extraKeys, n, e)) ||
    ...
    (e.target && e.target != i.display.input.getField()) ||
      ...
      we(i, e) ||
        ...
        18 != t ||
          ...
          (A((r = i.display.lineDiv), "CodeMirror-crosshair"),
          me(document, "keyup", o),
  ...
  function _o(e) {
    ...
    if (
      ...
      var n,
        r = e.keyCode,
        i = e.charCode;
      if (p && r == Xo) return ((Xo = null), void Le(e));
      (p && (!e.which || e.which < 10) && jo(t, e)) ||
        ("\b" != (i = String.fromCharCode(null == i ? r : i)) &&
          (Vo((n = t), "'" + i + "'", e, function (e) {
            return Go(n, e, !0);
          }) ||
          ...
          (i = t
            ? ((r = t),
              ...
              Qo && Qo.compare(o, r, i)
                ? ((Zo = Qo = null), "triple")
                : Zo && Zo.compare(o, r, i)
                  ? ((Qo = new qo(o, r, i)), (Zo = null), "double")
                  : ((Zo = new qo(o, r, i)), (Qo = null), "single"))
            : "single"),
          window.focus(),
          ...
          (t &&
            (function (n, e, r, t, i) {
              ...
              return Vo(
                ...
                i,
                function (e) {
                  if (!(e = "string" == typeof e ? Ro[e] : e)) return !1;
                  var t = !1;
                  try {
              ...
              ? t
                ? (function (e, t, n, r) {
                    ...
                    (e.options.dragDrop &&
                      ...
                      "single" == n &&
                      -1 < (i = l.contains(t)) &&
                      (nt((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) &&
                      (0 < nt(i.to(), t) || t.xRel < 0)
                      ? function (t, n, r, i) {
                          var o = t.display,
                            l = !1,
                            s = Er(t, function (e) {
                            ...
                            if (0 != nt(b, e))
                              if (((b = e), "rectangle" == p.unit)) {
                                for (
                                  var t = [],
                                    n = d.options.tabSize,
                                    r = E(Ye(g, f.line).text, f.ch, n),
                                    i = E(Ye(g, e.line).text, e.ch, n),
                                    o = Math.min(r, i),
                                    l = Math.max(r, i),
                                  ...
                                  var u = Ye(g, s).text,
                                    c = K(u, o, n);
                                  o == l
                                    ? t.push(new oi(tt(s, c), tt(s, c)))
                                    : u.length > c &&
                                      t.push(
                                        new oi(tt(s, c), tt(s, K(u, l, n))),
                                      );
                                }
                                ...
                                var h,
                                  ...
                                  e =
                                    0 < nt(i.anchor, e)
                                      ? ((h = i.head), lt(r.from(), i.anchor))
                                      : ((h = i.anchor), ot(r.to(), i.head)),
                                  i = y.ranges.slice(0);
                                ((i[v] = (function (e, t) {
                                  var n = t.anchor,
                                    r = t.head,
  ...
  function el(e, t, n) {
    ...
    if ("line" == n) return new oi(tt(t.line, 0), at(e.doc, tt(t.line + 1, 0)));
    t = n(e, t);
  ...
  function tl(e, t, n, r) {
    ...
    if (o > r.bottom || !Ce(e, n)) return Te(t);
    o -= r.top - l.viewOffset;
    for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
      var a = l.gutters.childNodes[s];
      if (a && a.getBoundingClientRect().right >= i)
        return (
          be(e, n, e, Qe(e.doc, o), e.display.gutterSpecs[s].className, t),
          Te(t)
        );
    }
  }
  ...
  function rl(e, t) {
    ...
    pn(e.display, t) ||
      ((r = t),
      Ce((n = e), "gutterContextMenu") && tl(n, r, "gutterContextMenu", !1)) ||
      we(e, t, "contextmenu") ||
      x ||
  ...
  function ul(e) {
    (e.options.lineWrapping
      ...
      : (S(e.display.wrapper, "CodeMirror-wrap"), Vt(e)),
      Qn(e),
      tr(e),
      Dn(e),
      setTimeout(function () {
  ...
  function cl(e, t) {
          ...
          w && v < 11
            ? Er(r, function (e) {
                ...
                we(r, e) ||
                  ...
                  nl(r, e) ||
                  pn(r.display, e) ||
                  (Le(e), (t = r.findWordAt(t)), Ai(r.doc, t.anchor, t.head));
              })
            : function (e) {
                return we(r, e) || Le(e);
              },
      ...
      (me(i.scroller, "touchstart", function (e) {
            ...
            (t =
              !n.prev || s(n, n.prev)
                ...
                : !n.prev.prev || s(n, n.prev.prev)
                  ? r.findWordAt(t)
                  : new oi(tt(t.line, 0), at(r.doc, tt(t.line + 1, 0)))),
        ...
        (i.dragFunctions = {
          ...
          start: function (e) {
            ...
            ((t = r),
              (n = e),
              w && (!t.state.draggingText || +new Date() - po < 100)
                ? Me(n)
                : we(t, n) ||
                  pn(t.display, n) ||
    ...
    for (var l = 0; l < hl.length; ++l) hl[l](this);
    (Fr(this),
      f &&
        t.lineWrapping &&
  ...
  function dl(e, t, n, r) {
    ...
    if (r || /\S/.test(s.text)) {
      if (
        "smart" == n &&
        ((c = o.mode.indent(i, s.text.slice(u.length), s.text)) == B || 150 < c)
      ) {
        if (!r) return;
        n = "prev";
      }
    ...
    "prev" == n
      ? (c = t > o.first ? E(Ye(o, t - 1).text, null, l) : 0)
      : "add" == n
    ...
    if ((d < c && (h += X(c - d)), h != u))
      return (
        qi(o, h, tt(t, 0), tt(t, u.length), "+input"),
        !(s.stateAfter = null)
      );
      ...
      f.empty() &&
        (n && 0 < n
          ...
          : e.state.overwrite && !s
            ? (g = tt(
                g.line,
                Math.min(Ye(o, g.line).text.length, g.ch + Y(a).length),
              ))
            : s &&
              fl &&
              fl.lineWise &&
  ...
  function xl(i, o, l, s, a) {
    ...
    function n(e) {
      ...
      if (
        ...
        (n =
          "codepoint" == s
            ? ((t = u.text.charCodeAt(o.ch + (0 < l ? 0 : -1))),
              isNaN(t)
                ? null
                : ((n =
        ...
        if (
          ...
          (r = o.line + c) < i.first ||
          r >= i.first + i.size ||
          ((o = new tt(r, o.ch, o.sticky)), !(u = Ye(i, r)))
        )
          return;
      ...
      if (o.node == r)
        return (function (u, e, t) {
          var n = u.text.firstChild,
            r = !1;
          if (!e || !N(n, e)) return Ll(tt(Ze(u.line), 0), !0);
          ...
          for (
            ...
            if ((s = l(a, a.firstChild, 0))) return Ll(tt(s.line, s.ch - d), r);
  ...
  ((e.prototype.init = function (e) {
    ...
    (e.prototype.focus = function () {
      "nocursor" != this.cm.options.readOnly &&
        ((this.selectionInEditor() && O() == this.div) ||
    ...
    (e.prototype.pollContent = function () {
      ...
      if (
        (0 == i.ch &&
          i.line > t.firstLine() &&
          (i = tt(i.line - 1, Ye(t.doc, i.line - 1).length)),
        r.ch == Ye(t.doc, r.line).text.length &&
          r.line < t.lastLine() &&
          (r = tt(r.line + 1, 0)),
      ...
      var o,
        l =
          i.line == n.viewFrom || 0 == (l = er(t, i.line))
            ? ((e = Ze(n.view[0].line)), n.view[0].node)
            : ((e = Ze(n.view[l].line)), n.view[l - 1].node.nextSibling),
        r = er(t, r.line),
        r =
          r == n.view.length - 1
            ? ((o = n.viewTo - 1), n.lineDiv.lastChild)
            : ((o = Ze(n.view[r + 1].line) - 1),
      ...
      for (
        var s = t.doc.splitLines(
          ...
          a = $e(t.doc, tt(e, 0), tt(o, Ye(t.doc, o).text.length));
        1 < s.length && 1 < a.length;
      )
        if (Y(s) == Y(a)) (s.pop(), a.pop(), o--);
        else {
          if (s[0] != a[0]) break;
          (s.shift(), a.shift(), e++);
        }
      ...
      ((l = tt(e, u)), (r = tt(o, a.length ? Y(a).length - c : 0)));
      return 1 < s.length || s[0] || nt(l, r)
        ? (qi(t.doc, s, l, r, "+input"), !0)
        : void 0;
    }),
  ...
  ((r.prototype.init = function (n) {
    ...
    function t(e) {
      if (!we(i, e)) {
        if (i.somethingSelected())
          pl({ lineWise: !1, text: i.getSelections() });
        else {
    ...
    (r.prototype.onContextMenu = function (e) {
      ...
      u &&
        ...
        x
          ? (Me(e),
            (a = function () {
              (ye(window, "mouseup", a), setTimeout(d, 20));
            }),
            me(window, "mouseup", a))
          : setTimeout(d, 50));
    }),
    ...
    Dl(
      ...
      [],
      function (e, t) {
        ((e.display.gutterSpecs = _r(t, e.options.lineNumbers)), Zr(e));
      },
      !0,
    ),
    Dl(
    ...
    Dl(
      ...
      !1,
      function (e, t) {
        ((e.display.gutterSpecs = _r(e.options.gutters, t)), Zr(e));
      },
      !0,
    ),
    ...
    (Nl.prototype = {
      ...
      getHelpers: function (e, t) {
        var n = [];
        if (!Al.hasOwnProperty(t)) return n;
        var r = Al[t],
          i = this.getModeAt(e);
      ...
      getStateAfter: function (e, t) {
        ...
        return pt(
          this,
          (e = st(n, null == e ? n.first + n.size - 1 : e)) + 1,
          t,
        ).state;
      },
      ...
      lineAtHeight: function (e, t) {
        return (
          (e = En(this, { top: e, left: 0 }, t || "page").top),
        ...
        var r,
          ...
          e =
            "number" == typeof e
              ...
              : e;
        return (
          Pn(this, e, { top: 0, left: 0 }, t || "page", n || i).top +
          (i ? this.doc.height - Gt(e) : 0)
        );
      },
      ...
      findPosH: function (e, t, n, r) {
        ...
        t < 0 && ((i = -1), (t = -t));
        for (
          var o = at(this.doc, e), l = 0;
          l < t && !(o = xl(this.doc, o, i, n, r)).hitSide;
          ++l
        );
        return o;
      },
      moveH: Ir(function (t, n) {
        ...
        this.extendSelectionsBy(function (e) {
          return r.display.shift || r.doc.extend || e.empty()
            ? xl(r.doc, e.head, t, n, r.options.rtlMoveVisually)
            : t < 0
              ? e.from()
              : e.to();
        }, V);
    ...
    (Nl.registerHelper = function (e, t, n) {
      (Al.hasOwnProperty(e) || (Al[e] = Nl[e] = { _global: [] }),
        (Al[e][t] = n));
    }),
  ...
  for (Wl in ho.prototype)
    ho.prototype.hasOwnProperty(Wl) &&
      R(Fl, Wl) < 0 &&
  ...
  return (
    Se(ho),
    (cl.inputStyles = { textarea: r, contenteditable: e }),
    ...
    (cl.fromTextArea = function (t, n) {
      ...
      if (
        ...
        t.form && (me(t.form, "submit", r), !n.leaveSubmitMethodAlone))
      ) {
        var i = t.form,
          o = i.submit;
        try {
