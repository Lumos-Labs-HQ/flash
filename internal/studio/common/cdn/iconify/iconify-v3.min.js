...
var Iconify = (function (e) {
  ...
  var u = /^[a-z0-9]+(-[a-z0-9]+)*$/,
    f = function (e, n, t, r) {
      ...
      var u = i[0],
        f = u.split("-");
      if (f.length > 1) {
        var d = { provider: r, prefix: f.shift(), name: f.join("-") };
        return n && !s(d) ? null : d;
      }
      if (t && "" === r) {
        var l = { provider: r, prefix: "", name: u };
        return n && !s(l, t) ? null : l;
      }
      return null;
    },
    s = function (e, n) {
  ...
  function v(e) {
    ...
    for (var c in a) {
      var f = a[c],
        s = f.parent;
      if (!c.match(u) || "string" != typeof s || (!t[s] && !a[s]) || !l(f, i))
        return null;
    }
    return n;
  }
  ...
  var m = !1;
  function y(e) {
    var n = "string" == typeof e ? f(e, !0, m) : e;
    if (n) {
  ...
  function j(e, n) {
    ...
    var r = e.prefix;
    return !!s({ provider: n, prefix: r, name: "a" }) && !!g(h(n, r), e);
  }
  function w(e) {
    return !!y(e);
  }
  ...
  function M(e, n) {
    ...
    var c,
      ...
      l = o.height;
    null === f
      ? (c = C((u = null === s ? "1em" : "auto" === s ? l : s), d / l))
      : ((c = "auto" === f ? d : f),
        (u = null === s ? C(c, l / d) : "auto" === s ? l : s));
    var v = {},
      p = function (e, n) {
        (function (e) {
          return "unset" === e || "undefined" === e || "none" === e;
        })(n) || (v[e] = n.toString());
      };
    return (
      p("width", c),
  ...
  function L(e, n) {
    ...
    var i = "suffix" + ((16777216 * Math.random()) | Date.now()).toString(16);
    return (
  ...
  function Q(e, n) {
    return V(e, R, n.toString());
  }
  function G(e) {
    return parseInt(U(e, R)) || 0;
  }
  ...
  function K(e, n) {
    ...
    if (t) {
      ...
      if (r !== _) {
        ...
        return (V(t, $, _), void Q(t, 0));
      }
      for (
        var a = Math.floor(Date.now() / q) - 168,
          c = function (e) {
            var r = D + e.toString(),
              i = U(t, r);
            if ("string" == typeof i) {
        ...
        var o = {
          ...
          callback: function (n, t) {
            !(function (n, t, r) {
              ...
              if ("abort" === t) return ((f = r), void y());
              if (o)
                return ((f = r), void (p.length || (i.length ? j() : y())));
              if ((g(), x(), !e.random)) {
  ...
  var xe = function (e, n) {
      var t,
        r = (function (e, n, t) {
          ...
          return (
            e.forEach(function (e) {
              var i = "string" == typeof e ? f(e, n, t) : e;
              i && r.push(i);
            }),
            r
          );
  ...
  function Ze(e, n, t) {
    ...
    r.innerHTML = c;
    for (var u = r.childNodes[0], f = e.attributes, s = 0; s < f.length; s++) {
      var d = f.item(s),
        l = d.name;
  ...
  function ln(e, n) {
    ...
    (e ? [e] : Me()).forEach(function (e) {
        ...
        ((function (e) {
          ...
          if (!a) {
            ...
            return s
              ? void c(t, r, s)
              : ((o = o || "loading" === f),
                void (t[Ee] = Object.assign({}, r, { status: f })));
          }
          if (
            (function (e, n) {
      ...
      function c(n, t, i) {
        if ((a || ((a = !0), Re(e)), "SVG" !== n.tagName.toUpperCase())) {
          var o = t.mode,
            c =
              "mask" === o ||
              ("bg" !== o &&
          ...
          if ("boolean" == typeof c)
            return void (function (e, n, t, r) {
              var i = n.customisations,
                ...
                f = Xe(e, We(n.icon), new Set(c && c.addedClasses)),
                s =
                ...
                d = Object.assign(
                  {},
                  { "--svg": s, width: fn(a.width), height: fn(a.height) },
                  en,
                  r ? nn : tn,
                );
              var l;
